...
export default function SpeakingScreen({ navigation }) {
  return (
    <View style={styles.container}>
      <Header title="Speaking Skill" icon="microphone-alt" />
      <SkillContent
        description="Improve your speaking fluency step-by-step."
        image={require("../../assets/speaking.png")}
        onPress={() => alert("Start Speaking Practice!")}
      />
    </View>
  );
}
